...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/muhammadrafey/Documents/code/work/xr/app/XR-archaeology-app_v2/ios/Pods/Target Support Files/Pods-XRarchaeology/ExpoModulesProvider.swift"
