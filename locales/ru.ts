...
export const ru: Translations = {
  ...
  booking: {
    ...
    placesLeft: "Осталось мест: {count}",
    onePlaceLeft: "Осталось мест: 1",
    full: "Все места уже забронированы.",
    ...
    confirmTitle: "Забронировать это событие?",
    confirmBook: "Забронировать",
  },
