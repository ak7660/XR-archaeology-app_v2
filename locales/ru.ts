...
export const ru: Translations = {
  ...
  welcome: {
    tagline: "Откройте для себя крепость Веди и долину реки: реконструкции в дополненной реальности, пешие маршруты, местные события и ИИ-планировщик поездок.",
    createAccount: "Создать аккаунт",
    signIn: "Войти",
    guest: "Продолжить как гость",
    guestNote: "Гостям доступно всё. Для бронирования событий и сохранения планов поездок нужен аккаунт.",
  },

  booking: {
    title: "Забронируйте место",
    free: "Бронирование бесплатное. Войдите, чтобы организаторы знали, что вы придёте.",
    signIn: "Войти и забронировать",
    confirmEmail: "Чтобы бронировать, подтвердите адрес электронной почты.",
    confirmEmailButton: "Подтвердить почту",
    noBooking: "Бронировать не нужно. Просто приходите.",
    day: "День",
    adults: "Взрослые",
    children: "Дети",
    childrenHint: "От 0 до 17 лет",
    placesLeft: "Осталось мест в этот день: {count}",
    onePlaceLeft: "Осталось мест в этот день: 1",
    full: "На этот день мест нет.",
    full_short: "Мест нет",
    bookOne: "Забронировать 1 место",
    bookMany: "Забронировать мест: {count}",
    booked: "Вы забронировали",
    emailed: "Мы отправили подробности на {email}.",
    cancel: "Отменить бронь",
    cancelTitle: "Отменить эту бронь?",
    cancelMessage: "Ваши места освободятся для других посетителей.",
    cancelConfirm: "Отменить бронь",
    keep: "Оставить",
    bookAnother: "Забронировать другой день",
    adultOne: "Взрослых: 1",
    adultMany: "Взрослых: {count}",
    childOne: "детей: 1",
    childMany: "детей: {count}",
    myBookings: "Мои бронирования",
    upcoming: "Предстоящие",
    pastAndCancelled: "Прошедшие и отменённые",
    statusCancelled: "Отменено",
    statusAttended: "Посещено",
    empty: "Бронирований пока нет. Здесь появятся события, которые вы забронируете.",
    browseEvents: "Посмотреть события",
    loadFailed: "Не удалось загрузить бронирования. Потяните вниз, чтобы повторить.",
    errorGeneric: "Бронирование не прошло. Попробуйте снова.",
    createAccount: "Создать аккаунт",
  },

  tripPlans: {
    title: "Мои планы поездок",
    planReady: "План готов",
    inProgress: "В процессе",
    updated: "Обновлено {when}",
    untitled: "План поездки",
    datesNotSet: "Даты ещё не выбраны",
    peopleOne: "1 человек",
    peopleMany: "Человек: {count}",
    empty: "Сохранённых планов пока нет. Планы, созданные после входа, хранятся здесь.",
    planTrip: "Спланировать поездку",
    deleteTitle: "Удалить этот план?",
    deleteMessage: "Разговор и маршрут будут удалены.",
    delete: "Удалить",
    cancel: "Отмена",
    signInHint: "Войдите, чтобы сохранять планы поездок.",
    signIn: "Войти",
    signInToSee: "Войдите, чтобы увидеть сохранённые планы.",
    newPlan: "Новый план",
    loadFailed: "Не удалось открыть план. Возможно, он удалён.",
  },
